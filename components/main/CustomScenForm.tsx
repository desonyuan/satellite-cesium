...
const keys = CustomSceneField.map((item) => item.key);

interface IProps {
  onClose: () => void;
}

const CustomScenForm: FC<PropsWithChildren<IProps>> = ({ onClose }) => {
